...
- You will need to have completed most (if not all) of the Tasks listed on [the Data page](data.qmd) in order to finish the proposal, but none of the work described on [the Analysis page](analysis.qmd).
